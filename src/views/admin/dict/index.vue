  ...
  <div class="app-container">
    ...
    <div class="app-container-content">
      <el-table
        ...
        <el-table-column label="字典编码" min-width="120" align="center" show-overflow-tooltip>
          <template slot-scope="scope">
            {{scope.row.code}}
          </template>
        </el-table-column>
        ...
        <el-table-column label="父级类型" min-width="100" align="center">
          <template slot-scope="scope">
            {{scope.row.parentType}}
          </template>
        </el-table-column>
        <el-table-column label="父级编码" min-width="100" align="center" show-overflow-tooltip>
          <template slot-scope="scope">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="父级字典" prop="parentCode">
              <el-select style="width: 100%" @change="selectParentType" v-model="dictForm.parentCode">
                <el-option
...
<script>
import {fetchDictListByPage, fetchDictType, fetchDictByType, updateDict, updateDictType, createDict, deleteDict} from '@/api/admin/dict'
  ...
  methods: {
    ...
    getDictByType(type){
      ...
      if (this.dialogType === 'new'){
        this.dictForm.parentCode = ''
        this.dictForm.parentType = ''
      }
    ...
    selectParentType(val){
      console.log(val)
      for (let o of this.parentDictList){
        if (o.code === val){
          this.dictForm.parentType = o.type
        }
      }
    },
    save() {
